...
public class App {
    ...
    public static void main(String[] args) {
        ...
        AbstractApplicationContext context = new ClassPathXmlApplicationContext("file:/Users/ravi/Documents/TestProjects/SpringCore/springcore/src/main/java/com/beanlifecycle/config.xml");
